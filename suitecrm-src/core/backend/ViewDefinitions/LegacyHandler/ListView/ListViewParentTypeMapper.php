...
namespace App\ViewDefinitions\LegacyHandler\ListView;
...
class ListViewParentTypeMapper implements ViewDefinitionMapperInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        return 'listview-parent-field-type-mapper';
    }
