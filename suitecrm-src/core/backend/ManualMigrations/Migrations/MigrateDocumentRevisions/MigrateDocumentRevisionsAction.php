...
class MigrateDocumentRevisionsAction implements ProcessHandlerInterface
{
    protected const MSG_OPTIONS_NOT_FOUND = 'Process options are not defined';
    protected const PROCESS_TYPE = 'migration-task-migrate-document-revisions';
    ...
    public function configure(Process $process): void
    {
        ...
        $process->setAsyncHandlerKey('migrate-document-revisions');
