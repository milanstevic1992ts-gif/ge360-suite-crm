...
abstract class MigratePersonPhotosAction implements ProcessHandlerInterface
{
    protected const MSG_OPTIONS_NOT_FOUND = 'Process options are not defined';

    abstract protected function getHandlerKey(): string;
    ...
    public function configure(Process $process): void
    {
        ...
        $process->setAsyncHandlerKey($this->getHandlerKey());
