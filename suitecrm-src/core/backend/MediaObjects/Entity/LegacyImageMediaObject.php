...
#[ORM\Entity(repositoryClass: LegacyImageMediaObjectRepository::class)]
#[ORM\Table(name: 'legacy_images_media_objects')]
#[ApiResource(
...
class LegacyImageMediaObject implements MediaObjectInterface
{
