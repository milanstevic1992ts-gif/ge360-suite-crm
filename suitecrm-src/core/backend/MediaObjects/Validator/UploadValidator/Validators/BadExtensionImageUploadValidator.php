...
class BadExtensionImageUploadValidator implements UploadValidatorInterface
{
    ...
    {
        return 'bad-extension-image-upload-validator';
    }
    ...
    {
        return 'LBL_UNSUPPORTED_IMAGE_FILE_TYPE';
    }
    ...
    public function validate($value, string $storageType, Constraint $constraint, ExecutionContextInterface $context): void
    {
        ...
        $allowedExtensions = $this->systemConfigProvider->getSystemConfig('valid_image_ext')->getValue() ?? ['jpg', 'png', 'gif'];
        ...
        $extensions = $mimeTypes->getExtensions($value->getMimeType());
