...
final class Version20260217120000 extends BaseMigration implements ContainerAwareInterface
{
    ...
    {
        $this->log('Migration Version20260217120000: Adding Migrate Notes Attachments task');
        ...
        if ((int)$existing > 0) {
            $this->log('Migration Version20260217120000: Task already exists, skipping');
            return;
        }
        ...
        $this->connection->insert('manual_migration_tasks', [
            ...
            'description' => 'Migrates Notes file attachments from legacy storage (upload/{note_id}) to the new media object storage system.',
            'date_entered' => $now,
            'date_modified' => $now,
            'created_by' => '1',
            'modified_user_id' => '1',
