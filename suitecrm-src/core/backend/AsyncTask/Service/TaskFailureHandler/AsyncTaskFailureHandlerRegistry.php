...
class AsyncTaskFailureHandlerRegistry implements AsyncTaskFailureHandlerRegistryInterface
{
    /**
     * @var AsyncTaskFailureHandlerInterface[][]
     */
    ...
    {
        /** @var AsyncTaskFailureHandlerInterface[] $handlersArray */
        $handlersArray = [];
    ...
    public function getHandler(string $type, string $handlerKey): ?AsyncTaskFailureHandlerInterface
    {
