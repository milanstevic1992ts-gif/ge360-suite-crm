...
class RerunAsyncTaskAction implements ProcessHandlerInterface
{
    protected const PROCESS_TYPE = 'record-rerun-async-task';
    ...
    public function run(Process $process): void
    {
        ...
        $this->itemRepository->purgeByTaskId($id);
        ...
        $process->setMessages(['LBL_RERUN_SUCCESS']);
        $process->setData(
            [
                'reload' => true,
                'dataUpdated' => true,
