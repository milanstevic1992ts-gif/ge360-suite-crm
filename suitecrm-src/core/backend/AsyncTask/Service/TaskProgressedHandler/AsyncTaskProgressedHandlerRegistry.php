...
class AsyncTaskProgressedHandlerRegistry implements AsyncTaskProgressedHandlerRegistryInterface
{
    /**
     * @var AsyncTaskProgressedHandlerInterface[][]
     */
    protected array $registry = [];

    /**
     * AsyncTaskProgressHandlerRegistry constructor.
     * @param Traversable $handlers
     */
    public function __construct(Traversable $handlers)
    {
        /** @var AsyncTaskProgressedHandlerInterface[] $handlersArray */
        $handlersArray = [];
    ...
    public function getHandler(string $type, string $handlerKey): ?AsyncTaskProgressedHandlerInterface
    {
