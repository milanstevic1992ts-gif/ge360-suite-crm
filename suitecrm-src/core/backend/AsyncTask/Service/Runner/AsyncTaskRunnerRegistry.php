...
class AsyncTaskRunnerRegistry implements AsyncTaskRunnerRegistryInterface
{
    /**
     * @var AsyncTaskRunnerInterface[]
     */
    ...
    {
        /** @var AsyncTaskRunnerInterface[] $handlersArray */
        $handlersArray = [];
    ...
    public function getRunner(string $type): ?AsyncTaskRunnerInterface
    {
