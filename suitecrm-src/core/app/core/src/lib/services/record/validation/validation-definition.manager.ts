...
export class ValidationDefinitionManager {

    getValidationDefinition(definition: FieldDefinition, type: string): ValidationDefinition {

        if (this.isType(definition?.validation, type)) {
    ...
    protected isType(validation: ValidationDefinition, type: string): boolean {
