...
export abstract class RecordThreadModalHeaderActionHandler extends ActionHandler<RecordThreadModalActionData> {
    ...
    abstract run(data: RecordThreadModalActionData): void;

    abstract shouldDisplay(data: RecordThreadModalActionData): boolean;

    checkRecordAccess(data: RecordThreadModalActionData, defaultAcls: string[] = []): boolean {
        return true;
    }
