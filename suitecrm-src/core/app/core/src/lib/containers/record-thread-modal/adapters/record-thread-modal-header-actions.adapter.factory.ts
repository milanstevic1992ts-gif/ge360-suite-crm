...
import {RecordThreadModalHeaderActionsAdapter} from "./record-thread-modal-header-actions.adapter";
import {RecordMapperRegistry} from "../../../common/record/record-mappers/record-mapper.registry";

@Injectable({
    providedIn: 'root',
})
export class RecordThreadModalHeaderActionsAdapterFactory {
    ...
    create(store: RecordThreadModalStore, activeModal: NgbActiveModal): RecordThreadModalHeaderActionsAdapter {
        return new RecordThreadModalHeaderActionsAdapter(
            store,
            activeModal,
            this.metadata,
            this.language,
