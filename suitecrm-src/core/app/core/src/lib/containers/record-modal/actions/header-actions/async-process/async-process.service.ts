...
import {RecordModalHeaderActionHandler} from "../record-modal-header.action";
import {RecordModalActionData} from "../../record-actions/record-modal-record.action";

@Injectable({
    providedIn: 'root'
})
export class AsyncProcessRecordModalHeaderAction extends RecordModalHeaderActionHandler {
