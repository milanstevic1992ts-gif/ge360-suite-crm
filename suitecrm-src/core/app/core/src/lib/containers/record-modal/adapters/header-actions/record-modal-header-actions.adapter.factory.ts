...
import {RecordModalHeaderActionsAdapter} from "./record-modal-header-actions.adapter";
...
export class RecordModalHeaderActionsAdapterFactory {

    constructor(
        protected metadata: MetadataStore,
        protected language: LanguageStore,
        protected actionManager: RecordModalHeaderActionManager,
    ...
    create(store: RecordModalStore, activeModal: NgbActiveModal): RecordModalHeaderActionsAdapter {
        return new RecordModalHeaderActionsAdapter(
            store,
            activeModal,
            this.metadata,
            this.language,
