...
import {RecordModalFooterActionHandler} from "../record-modal-footer.action";

@Injectable({
    providedIn: 'root'
})
export class AsyncProcessRecordModalFooterAction extends RecordModalFooterActionHandler {
