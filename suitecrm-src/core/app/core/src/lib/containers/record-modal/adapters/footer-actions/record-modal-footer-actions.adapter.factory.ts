...
export class RecordModalFooterActionsAdapterFactory {
    ...
    create(store: RecordModalStore, activeModal: NgbActiveModal): RecordModalFooterActionsAdapter {
        return new RecordModalFooterActionsAdapter(
            store,
            activeModal,
            this.metadata,
            this.language,
