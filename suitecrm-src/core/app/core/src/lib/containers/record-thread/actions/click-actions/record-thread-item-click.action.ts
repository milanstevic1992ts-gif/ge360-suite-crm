...
export interface RecordThreadItemClickActionData extends RecordBasedActionData {
    itemStore?: RecordThreadItemStore;
    threadStore?: RecordThreadStore;
    action?: Action;
}

export abstract class RecordThreadItemClickActionHandler extends ActionHandler<RecordThreadItemClickActionData> {

    abstract run(data: RecordThreadItemClickActionData): void;

    abstract shouldDisplay(data: RecordThreadItemClickActionData): boolean;

    checkRecordAccess(data: RecordThreadItemClickActionData, defaultAcls: string[] = []): boolean {
