...
import {RecordThreadItemClickActionAdapter} from './record-thread-item-click-action.adapter';
...
import {RecordThreadItemClickActionResolverService} from '../actions/click-actions/record-thread-item-click-action-resolver.service';
...
export class RecordThreadItemClickActionAdapterFactory {
    ...
    create(
        ...
        clickActionConfigs: RecordThreadItemClickActionConfig[]
    ): RecordThreadItemClickActionAdapter {
        const adapter = new RecordThreadItemClickActionAdapter(
            itemStore,
            threadStore,
            this.language,
            this.actionManager,
            ...
            this.logic,
            this.recordManager,
            this.clickActionResolver
        );

        adapter.initResolvedClickAction(clickActionConfigs);
