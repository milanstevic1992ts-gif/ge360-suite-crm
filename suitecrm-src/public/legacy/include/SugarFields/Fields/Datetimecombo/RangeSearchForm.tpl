...
<div id="{$id}_range_div" style="{if preg_match('/^\[/', (string) $smarty.request.{{$id_range}}|default:'')  || $starting_choice == 'between'}display:none{else}display:''{/if};" class="datecalendar">
